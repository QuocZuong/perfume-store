...
-- Create the Import_Stash table
CREATE TABLE Import_Stash (
...
-- Create the Import_Detail table
...
-- Create the Product_Activity_Log table
...
-- Import_Stash to Inventory_Manager and Product
ALTER TABLE Import_Stash
ADD CONSTRAINT FK_ImportStash_InventoryManager
FOREIGN KEY (Inventory_Manager_ID)
REFERENCES Inventory_Manager(Inventory_Manager_ID);

ALTER TABLE Import_Stash
ADD CONSTRAINT FK_ImportStash_Product
FOREIGN KEY (Product_ID)
REFERENCES Product(Product_ID);
...
-- Import_Detail to Import, Product, and Admin
...
-- Import_Detail to Admin
ALTER TABLE Import_Detail
ADD CONSTRAINT FK_ImportDetail_Admin
FOREIGN KEY (Modified_By_Admin)
REFERENCES Admin(Admin_ID);
