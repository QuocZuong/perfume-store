...
public class DataManager {
	 ...
	 * @param data A string containing the data to be inserted into the table. The
	 * data should be in the format of comma-separated values, with each value
	 ...
	 * @param condition A string representing the condition to be used in the SQL
	 * query's WHERE clause. It can be an empty string if no condition is needed.
	 ...
	 * select(sinhvien, "WHERE ABCD", "id", "name") return SELECT id, name FROM
	 * sinhvien WHERE ABDC
	 * @throws SQLException
	 */
