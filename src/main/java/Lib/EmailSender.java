...
public class EmailSender {
    ...
    public String changeEmailNotification(String newEmail) {
        ...
        String html = "<!DOCTYPE html>\n"
                ...
                + "\n"
                + "                                                                <p style=\"margin: 0 0 16px;\">Xin chào " + username + ",</p>\n"
                + "                                                                <p style=\"margin: 0 0 16px;\">Thông báo này xác nhận rằng email của bạn trên Affordable STORE đã được thay đổi thành <strong><a href=\"mailto:" + newEmail + "\">" + newEmail + "</a></strong>.\n"
                + "                                                                </p>\n"
    ...
    public String changeUsernameNotification(String newUsername) {
        ...
        String html = "<!DOCTYPE html>\n"
                ...
                + "\n"
                + "                                                                <p style=\"margin: 0 0 16px;\">Xin chào " + username + ",</p>\n"
                + "                                                                <p style=\"margin: 0 0 16px;\">Thông báo này xác nhận rằng username của bạn trên Affordable STORE đã được thay đổi thành <strong>" + newUsername + "</strong>.\n"
                + "                                                                </p>\n"
    ...
    public String getEmailSubscribe() {
        ...
        String html = "<!DOCTYPE html>\n"
                ...
                + "\n"
                + "                                                                <p style=\"margin: 0 0 16px;\">Xin chào " + username + ",</p>\n"
                + "                                                                <p style=\"margin: 0 0 16px;\">Thông báo này xác nhận rằng bạn đã thành công nhận tin từ Affordable STORE\n"
                + "                                                                </p>\n"
