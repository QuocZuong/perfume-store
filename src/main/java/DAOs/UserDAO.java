...
public class UserDAO {
    ...
    public boolean isExistUsernameEceptItself(String username, int ID) {
        ResultSet rs = null;
    ...
    public boolean isExistPhoneEceptItself(String phone, int ID) {
        ResultSet rs = null;
    ...
    public boolean isExistEmailEceptItself(String email, int ID) {
