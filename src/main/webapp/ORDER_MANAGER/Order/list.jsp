                    ...
                    <c:choose>
                      <c:when test='<%= isAccepted%>'>
                        <td class="buttonStatus faded px-3" colspan=2>
                          <a href="/OrderManager/OrderList/ACCEPT/Order/ID/<%= o.getId()%>" class="btn btn-outline-success btn-disabled rounded-0 w-100" tabindex="-1">Accepted</a>
                        </td>
                      </c:when>
                      <c:when test='<%= isRejected%>'>
                        <td class="buttonStatus faded px-3" colspan=2>
                          <a href="/OrderManager/OrderList/REJECT/Order/ID/<%= o.getId()%>" class="btn btn-outline-danger btn-disabled rounded-0 w-100" tabindex="-1">Rejected</a>
                        </td>
                      </c:when>
                      <c:otherwise>
                        <td class="buttonStatus">
                          <a href="/OrderManager/OrderList/ACCEPT/Order/ID/<%= o.getId()%>" class="btn btn-outline-success rounded-0">Accept</a>
                        </td>
                        <td class="buttonStatus">
                          <a href="/OrderManager/OrderList/REJECT/Order/ID/<%= o.getId()%>" class="btn btn-outline-danger rounded-0">Reject</a>
                        </td>
                      </c:otherwise>
                    </c:choose>
                  </tr>
