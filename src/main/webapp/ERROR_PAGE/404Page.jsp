<%-- Document : 404Page Created on : Jul 10, 2023, 9:41:28 PM Author : quoczuong --%> <%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8" />
        ...
        <link rel="stylesheet" href="/RESOURCES/error/public/style/style.css" />
        <title>Page Not Found</title>
    </head>
    <body>
        <div class="container">
            <div class="top">
                <h1>4<img src="/RESOURCES/images/icons/perfume.png" alt="alt" />4</h1>
